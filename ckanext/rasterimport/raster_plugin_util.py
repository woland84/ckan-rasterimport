...
class RasterUtil:
    ...
    def download_file_to_temp_directory(file_url, file_name):
        ...
        file_temp_path = tempfile.gettempdir() + "/" + str(file_name) + ".raster"
    ...
    def write_gml_string_to_temp_file(gml, coverage_id):
        ...
        """
        file_temp_path = tempfile.gettempdir() + "/" + str(coverage_id) + ".xml"
        file_handle = open(file_temp_path, "wb")
    ...
    @staticmethod
    def get_wcst_url():
        return config.get("ckan.rasterimport.wcst_base_url", "").strip(' \t\n\r')
    ...
    def get_gml_path_from_dataset(coverage_url, dataset_id):
        ...
        if RasterUtil.is_gml(coverage_url):
            ...
            coverage_local_url = "file://" + coverage_local_path
            converter = GDALToGmlConverter(coverage_local_path, coverage_id, coverage_local_url)
