...
class GDALToGmlConverter:
    ...
    def get_center(self):
        ...
        xgeo = geo[0] + self.gdal_dataset.RasterXSize / 2 * geo[1] + self.gdal_dataset.RasterYSize / 2 * geo[2]
        ygeo = geo[3] + self.gdal_dataset.RasterXSize / 2 * geo[4] + self.gdal_dataset.RasterYSize / 2 * geo[5]
    ...
    def get_offset_vectors(self):
        ...
        offset_y = str(self.gdal_dataset.GetGeoTransform()[5]) + " 0"
